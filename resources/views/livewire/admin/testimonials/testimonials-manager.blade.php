<div class="p-6 lg:p-10">
    ...
    <div class="flex items-start justify-between mb-8">
        <div>
            ...
            <p class="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Manage your client's testimonials.</p>
        </div>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm overflow-hidden">
        @if($testimonials->isEmpty())
            <div class="py-16 text-center text-zinc-400 dark:text-zinc-500 text-sm">No testimonials yet.</div>
        @else
            ...
            @if($testimonials->hasPages())
                <div class="px-6 py-4 border-t border-zinc-100 dark:border-zinc-800">{{ $testimonial->links() }}</div>
            @endif
        @endif
    </div>
    ...
    <div x-data="{ show: @entangle('showModal').live }"
        ...
        <div @click.stop
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-zinc-600 dark:text-zinc-300 mb-1.5 uppercase tracking-wide">Client</label>
                ...
                <div>
                 ...
                 <div>
                    <label class="block text-xs font-semibold text-zinc-600 dark:text-zinc-300 mb-1.5 uppercase tracking-wide">Quote</label>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="test_is_published" class="text-sm text-zinc-700 dark:text-zinc-300 font-medium">Published</label>
                </div>
            </div>
    ...
    <div x-data="{ show: @entangle('deletingId').live }"
        ...
        <div @click.stop class="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl w-full max-w-sm p-6 text-center border border-zinc-100 dark:border-zinc-800">
            <p class="text-lg font-bold text-zinc-800 dark:text-zinc-100 mb-2">Delete testimonial?</p>
