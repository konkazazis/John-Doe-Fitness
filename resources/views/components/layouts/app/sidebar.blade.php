...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body
        class="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-100"
    >
        <flux:sidebar
            sticky
            collapsible="mobile"
            class="border-e border-zinc-200 bg-white shadow-sm dark:bg-zinc-900 dark:border-zinc-800"
        >
            <flux:sidebar.header class="py-4">
                ...
                >
                    <div
                        class="w-8 h-8 rounded-md bg-zinc-900 flex items-center justify-center shrink-0"
                    >
                        <svg
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group heading="Content" class="grid">
                    ...
                    <flux:sidebar.item
                        ...
                        :current="request()->routeIs('admin.clients-messages.*')"
                        wire:navigate
                    >
                        Client Messages
                    </flux:sidebar.item>
        ...
        {{-- Mobile Header --}}
        <flux:header
            class="lg:hidden bg-white border-b border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800"
        >
            ...
            >
                <span
                    class="font-bold text-sm text-zinc-800 dark:text-zinc-100"
                >
                    Portfolio CMS
                </span>
            </a>
