<section id="contact" class="border-t border-stone-800 bg-stone-900 px-6 pt-24 pb-8 text-white sm:px-8">
    <div class="mx-auto max-w-3xl">
        <div class="reveal mb-8">
            ...
            <p class="text-on-dark-mut mt-[22px] max-w-[40ch] text-[1.1rem]">
            ...
            <div class="mt-[30px] flex gap-2.5">
                <a href="#" target="_blank" rel="noopener" aria-label="GitHub"
                    class="text-on-dark-mut hover:text-on-dark hover:border-on-dark grid h-11 w-11 place-items-center bg-slate-50 transition hover:-translate-y-[3px]">
                    ...
                    <a href="#" target="_blank" rel="noopener" aria-label="LinkedIn"
                        class="text-on-dark-mut hover:text-on-dark hover:border-on-dark grid h-11 w-11 place-items-center transition hover:-translate-y-[3px]">
